// Utah Teapot control mesh data, sourced from
// https://github.com/dasch/graphics/blob/master/data/teapot.data
// Axes remapped so the file's Z (height) becomes Y (up) and Y becomes Z (depth),
// matching this app's convention of Y-up with objects resting on y = 0.

export const TEAPOT_VERTICES: [number, number, number][] = [
  [1.4, 2.4, 0],
  [1.4, 2.4, -0.784],
  [0.78, 2.4, -1.4],
  [0, 2.4, -1.4],
...
// Each entry is the 16 control-point indices (0-based) of one bicubic Bezier
// patch, in row-major 4x4 order.
export const TEAPOT_PATCHES: number[][] = [
